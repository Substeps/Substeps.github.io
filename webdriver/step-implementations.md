...
<div class="row">
    ...
    <div class="col-sm-1">
         <button style ="margin-top:20px" class="dropup btn btn-sm btn-primary" type="button" onclick="javascript:toggleSection('assertion-steps', this);">
...
<table id="assertion-steps" class="table">
<thead>
...
<div class="row">
    ...
    <div class="col-sm-1">
         <button style ="margin-top:20px" class="dropup btn btn-sm btn-primary" type="button" onclick="javascript:toggleSection('clicks-steps', this);">
                <span class="caret"></span>
         </button>
    </div>
</div>
...
<table class="table" id="clicks-steps">
<thead>
    <tr><th>Keyword</th> <th>Example</th> <th>Description</th></tr>
</thead>
<tbody>          
...
<div class="row">
    ...
    <div class="col-sm-1">
         <button style ="margin-top:20px" class="dropup btn btn-sm btn-primary" type="button" onclick="javascript:toggleSection('forms-steps', this);">
                <span class="caret"></span>
         </button>
    </div>
</div>
...
<table class="table" id="forms-steps">
<thead>
    <tr><th>Keyword</th> <th>Example</th> <th>Description</th></tr>
</thead>
<tbody>          
...
<div class="row">
    ...
    <div class="col-sm-1">
         <button style ="margin-top:20px" class="dropup btn btn-sm btn-primary" type="button" onclick="javascript:toggleSection('finders-steps', this);">
                <span class="caret"></span>
         </button>
    </div>
</div>
...
<table class="table" id="finders-steps">
<thead>
    <tr><th>Keyword</th> <th>Example</th> <th>Description</th></tr>
</thead>
<tbody>          
...
<tr><td>FindRadioButton inside tag=&quot;&lt;tag&gt;&quot; with label=&quot;&lt;label&gt;&quot;</td><td>FindRadioButton inside tag="label" with label="a radio label"</td><td>Finds a radiobutton that is a child of the specified tag, that contains  the specified text; eg. &lt;label&gt;&lt;input type=&quot;radio&quot; name=&quot;radio_name&quot; value=&quot;yeah&quot;/&gt;a radio &lt;span&gt;label&lt;/span&gt; &lt;/label&gt;</td></tr>
...
<div class="row">
    ...
    <div class="col-sm-1">
         <button style ="margin-top:20px" class="dropup btn btn-sm btn-primary" type="button" onclick="javascript:toggleSection('misc-steps', this);">
                <span class="caret"></span>
         </button>
    </div>
</div>
...
<table class="table" id="misc-steps">
<thead>
    <tr><th>Keyword</th> <th>Example</th> <th>Description</th></tr>
</thead>
<tbody>          
...
<div class="row">
    <div class="col-sm-11">
        <h3 id="startstop">Startup / Shutdown</h3>
    </div>
    
    <div class="col-sm-1">
         <button style ="margin-top:20px" class="dropup btn btn-sm btn-primary" type="button" onclick="javascript:toggleSection('startuo-shutdown-steps', this);">
                <span class="caret"></span>
         </button>
    </div>
</div>
...
<table class="table" id="startuo-shutdown-steps">
<thead>
    <tr><th>Keyword</th> <th>Example</th> <th>Description</th></tr>
</thead>
<tbody>          
...
<div class="row">
    ...
    <div class="col-sm-1">
         <button style ="margin-top:20px" class="dropup btn btn-sm btn-primary" type="button" onclick="javascript:toggleSection('table-steps', this);">
                <span class="caret"></span>
         </button>
    </div>
</div>
...
<table class="table" id="table-steps">
<thead>
    <tr><th>Keyword</th> <th>Example</th> <th>Description</th></tr>
</thead>
<tbody>          
